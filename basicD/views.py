...
def basicD_template(request):
    return render(request,"basicD.html")


def basicD_form_show(request):
    return render(request,"basicDresult.html")

def basicD_form_show2(request):
    return render(request,"basicDresult2.html")


def basicD_form_show3(request):
    return render(request,"basicDresult3.html")

def basicD_form_show4(request):
    return render(request,"basicDresult4.html")

def basicD_form(request):
    ...
    return render(request,'basicDresult.html',payload)


def basicD_form2(request):
    sagilistA=sagilist()
    ...
    return render(request,'basicDresult2.html',payload)

def basicD_form4(request):
    sagidict=sagilist()
    hisagidict=hisagilist()
    data=request.POST.get("hidden_data")
    splitdata=(data.split(","))
    ...
    return render(request,'basicDresult4.html',payload)
